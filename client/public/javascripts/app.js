...
buf.push('><div');
buf.push(attrs({ "class": ('todo') + ' ' + ('todo-title') + ' ' + ('clearfix') }));
buf.push('><button');
buf.push(attrs({ "class": ("btn btn-large btn-success") }));
buf.push('>new task</button><span');
buf.push(attrs({ 'contenteditable':("true"), "class": ('description') }));
buf.push('>My task list</span></div><div');
buf.push(attrs({ "class": ('todo') }));
buf.push('><button');
...
buf.push('>todo</button><span');
buf.push(attrs({ 'contenteditable':("true"), "class": ('description') }));
buf.push('>my first task</span></div><div');
buf.push(attrs({ "class": ('todo') + ' ' + ('done') }));
buf.push('><button');
buf.push(attrs({ "class": ("btn disabled") }));
buf.push('>done</button><span');
buf.push(attrs({ "class": ('description') }));
buf.push('>my completed task, longer text</span></div></div></div>');
}
return buf.join("");
};
  }
